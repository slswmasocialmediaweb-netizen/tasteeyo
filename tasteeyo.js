...
// --- Icon Definitions ---
const icons = {
  Pipette, // Represents the tube/icicle format
  Leaf,    // Represents natural/healthy ingredients
  Sparkles, // Represents fun/quality
  Snowflake, // Represents the frozen nature
  ShoppingCart, // For CTA
};
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <style jsx global>{`
        /* Custom font for a fun brand feel */
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700;800;900&display=swap');
        body {
          font-family: 'Inter', sans-serif;
        }
        /* Custom Tailwind Configuration for display font (optional but nice) */
        .font-display {
          font-family: 'Inter', sans-serif; /* Keeping Inter for simplicity, but a unique font could be used */
        }
      `}</style>
    </div>
  );
